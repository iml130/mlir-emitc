...
module attributes {tf.versions = {bad_consumers = [], min_consumer = 12 : i32, producer = 812 : i32}, tf_saved_model.semantics}  {
  func.func @predict(%arg0: tensor<1x224x224x3xf32> {tf._user_specified_name = "args_0", tf_saved_model.index_path = [0]}) -> (tensor<1x1000xf32> {tf_saved_model.index_path = []}) attributes {tf._construction_context = "kEagerRuntime"} {
    ...
    %66 = "tosa.mul"(%62, %65) {shift = 0 : i8} : (tensor<1x112x112x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x112x112x32xf32>
    %67 = "tosa.reshape"(%31) {new_shape = array<i64: 1, 1, 1, 32>} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %68 = "tosa.mul"(%66, %67) {shift = 0 : i8} : (tensor<1x112x112x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x112x112x32xf32>
    ...
    %78 = "tosa.mul"(%74, %77) {shift = 0 : i8} : (tensor<1x112x112x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x112x112x32xf32>
    %79 = "tosa.reshape"(%31) {new_shape = array<i64: 1, 1, 1, 32>} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %80 = "tosa.mul"(%78, %79) {shift = 0 : i8} : (tensor<1x112x112x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x112x112x32xf32>
    ...
    %91 = "tosa.mul"(%87, %90) {shift = 0 : i8} : (tensor<1x112x112x16xf32>, tensor<1x1x1x16xf32>) -> tensor<1x112x112x16xf32>
    %92 = "tosa.reshape"(%20) {new_shape = array<i64: 1, 1, 1, 16>} : (tensor<16xf32>) -> tensor<1x1x1x16xf32>
    %93 = "tosa.mul"(%91, %92) {shift = 0 : i8} : (tensor<1x112x112x16xf32>, tensor<1x1x1x16xf32>) -> tensor<1x112x112x16xf32>
    ...
    %103 = "tosa.mul"(%99, %102) {shift = 0 : i8} : (tensor<1x112x112x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x112x112x96xf32>
    %104 = "tosa.reshape"(%43) {new_shape = array<i64: 1, 1, 1, 96>} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %105 = "tosa.mul"(%103, %104) {shift = 0 : i8} : (tensor<1x112x112x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x112x112x96xf32>
    ...
    %116 = "tosa.mul"(%112, %115) {shift = 0 : i8} : (tensor<1x56x56x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x56x56x96xf32>
    %117 = "tosa.reshape"(%43) {new_shape = array<i64: 1, 1, 1, 96>} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %118 = "tosa.mul"(%116, %117) {shift = 0 : i8} : (tensor<1x56x56x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x56x56x96xf32>
    ...
    %129 = "tosa.mul"(%125, %128) {shift = 0 : i8} : (tensor<1x56x56x24xf32>, tensor<1x1x1x24xf32>) -> tensor<1x56x56x24xf32>
    %130 = "tosa.reshape"(%25) {new_shape = array<i64: 1, 1, 1, 24>} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    %131 = "tosa.mul"(%129, %130) {shift = 0 : i8} : (tensor<1x56x56x24xf32>, tensor<1x1x1x24xf32>) -> tensor<1x56x56x24xf32>
    ...
    %141 = "tosa.mul"(%137, %140) {shift = 0 : i8} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    %142 = "tosa.reshape"(%28) {new_shape = array<i64: 1, 1, 1, 144>} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %143 = "tosa.mul"(%141, %142) {shift = 0 : i8} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    ...
    %153 = "tosa.mul"(%149, %152) {shift = 0 : i8} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    %154 = "tosa.reshape"(%28) {new_shape = array<i64: 1, 1, 1, 144>} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %155 = "tosa.mul"(%153, %154) {shift = 0 : i8} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    ...
    %166 = "tosa.mul"(%162, %165) {shift = 0 : i8} : (tensor<1x56x56x24xf32>, tensor<1x1x1x24xf32>) -> tensor<1x56x56x24xf32>
    %167 = "tosa.reshape"(%25) {new_shape = array<i64: 1, 1, 1, 24>} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    %168 = "tosa.mul"(%166, %167) {shift = 0 : i8} : (tensor<1x56x56x24xf32>, tensor<1x1x1x24xf32>) -> tensor<1x56x56x24xf32>
    ...
    %179 = "tosa.mul"(%175, %178) {shift = 0 : i8} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    %180 = "tosa.reshape"(%28) {new_shape = array<i64: 1, 1, 1, 144>} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %181 = "tosa.mul"(%179, %180) {shift = 0 : i8} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    ...
    %192 = "tosa.mul"(%188, %191) {shift = 0 : i8} : (tensor<1x28x28x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x28x28x144xf32>
    %193 = "tosa.reshape"(%28) {new_shape = array<i64: 1, 1, 1, 144>} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %194 = "tosa.mul"(%192, %193) {shift = 0 : i8} : (tensor<1x28x28x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x28x28x144xf32>
    ...
    %205 = "tosa.mul"(%201, %204) {shift = 0 : i8} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    %206 = "tosa.reshape"(%31) {new_shape = array<i64: 1, 1, 1, 32>} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %207 = "tosa.mul"(%205, %206) {shift = 0 : i8} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    ...
    %217 = "tosa.mul"(%213, %216) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %218 = "tosa.reshape"(%34) {new_shape = array<i64: 1, 1, 1, 192>} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %219 = "tosa.mul"(%217, %218) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    ...
    %229 = "tosa.mul"(%225, %228) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %230 = "tosa.reshape"(%34) {new_shape = array<i64: 1, 1, 1, 192>} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %231 = "tosa.mul"(%229, %230) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    ...
    %242 = "tosa.mul"(%238, %241) {shift = 0 : i8} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    %243 = "tosa.reshape"(%31) {new_shape = array<i64: 1, 1, 1, 32>} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %244 = "tosa.mul"(%242, %243) {shift = 0 : i8} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    ...
    %255 = "tosa.mul"(%251, %254) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %256 = "tosa.reshape"(%34) {new_shape = array<i64: 1, 1, 1, 192>} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %257 = "tosa.mul"(%255, %256) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    ...
    %267 = "tosa.mul"(%263, %266) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %268 = "tosa.reshape"(%34) {new_shape = array<i64: 1, 1, 1, 192>} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %269 = "tosa.mul"(%267, %268) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    ...
    %280 = "tosa.mul"(%276, %279) {shift = 0 : i8} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    %281 = "tosa.reshape"(%31) {new_shape = array<i64: 1, 1, 1, 32>} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %282 = "tosa.mul"(%280, %281) {shift = 0 : i8} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    ...
    %293 = "tosa.mul"(%289, %292) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %294 = "tosa.reshape"(%34) {new_shape = array<i64: 1, 1, 1, 192>} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %295 = "tosa.mul"(%293, %294) {shift = 0 : i8} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    ...
    %306 = "tosa.mul"(%302, %305) {shift = 0 : i8} : (tensor<1x14x14x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x14x14x192xf32>
    %307 = "tosa.reshape"(%34) {new_shape = array<i64: 1, 1, 1, 192>} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %308 = "tosa.mul"(%306, %307) {shift = 0 : i8} : (tensor<1x14x14x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x14x14x192xf32>
    ...
    %319 = "tosa.mul"(%315, %318) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %320 = "tosa.reshape"(%37) {new_shape = array<i64: 1, 1, 1, 64>} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %321 = "tosa.mul"(%319, %320) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    ...
    %331 = "tosa.mul"(%327, %330) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %332 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %333 = "tosa.mul"(%331, %332) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %343 = "tosa.mul"(%339, %342) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %344 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %345 = "tosa.mul"(%343, %344) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %356 = "tosa.mul"(%352, %355) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %357 = "tosa.reshape"(%37) {new_shape = array<i64: 1, 1, 1, 64>} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %358 = "tosa.mul"(%356, %357) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    ...
    %369 = "tosa.mul"(%365, %368) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %370 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %371 = "tosa.mul"(%369, %370) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %381 = "tosa.mul"(%377, %380) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %382 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %383 = "tosa.mul"(%381, %382) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %394 = "tosa.mul"(%390, %393) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %395 = "tosa.reshape"(%37) {new_shape = array<i64: 1, 1, 1, 64>} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %396 = "tosa.mul"(%394, %395) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    ...
    %407 = "tosa.mul"(%403, %406) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %408 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %409 = "tosa.mul"(%407, %408) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %419 = "tosa.mul"(%415, %418) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %420 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %421 = "tosa.mul"(%419, %420) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %432 = "tosa.mul"(%428, %431) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %433 = "tosa.reshape"(%37) {new_shape = array<i64: 1, 1, 1, 64>} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %434 = "tosa.mul"(%432, %433) {shift = 0 : i8} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    ...
    %445 = "tosa.mul"(%441, %444) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %446 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %447 = "tosa.mul"(%445, %446) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %457 = "tosa.mul"(%453, %456) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %458 = "tosa.reshape"(%40) {new_shape = array<i64: 1, 1, 1, 384>} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %459 = "tosa.mul"(%457, %458) {shift = 0 : i8} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    ...
    %470 = "tosa.mul"(%466, %469) {shift = 0 : i8} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    %471 = "tosa.reshape"(%43) {new_shape = array<i64: 1, 1, 1, 96>} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %472 = "tosa.mul"(%470, %471) {shift = 0 : i8} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    ...
    %482 = "tosa.mul"(%478, %481) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %483 = "tosa.reshape"(%46) {new_shape = array<i64: 1, 1, 1, 576>} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %484 = "tosa.mul"(%482, %483) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    ...
    %494 = "tosa.mul"(%490, %493) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %495 = "tosa.reshape"(%46) {new_shape = array<i64: 1, 1, 1, 576>} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %496 = "tosa.mul"(%494, %495) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    ...
    %507 = "tosa.mul"(%503, %506) {shift = 0 : i8} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    %508 = "tosa.reshape"(%43) {new_shape = array<i64: 1, 1, 1, 96>} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %509 = "tosa.mul"(%507, %508) {shift = 0 : i8} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    ...
    %520 = "tosa.mul"(%516, %519) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %521 = "tosa.reshape"(%46) {new_shape = array<i64: 1, 1, 1, 576>} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %522 = "tosa.mul"(%520, %521) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    ...
    %532 = "tosa.mul"(%528, %531) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %533 = "tosa.reshape"(%46) {new_shape = array<i64: 1, 1, 1, 576>} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %534 = "tosa.mul"(%532, %533) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    ...
    %545 = "tosa.mul"(%541, %544) {shift = 0 : i8} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    %546 = "tosa.reshape"(%43) {new_shape = array<i64: 1, 1, 1, 96>} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %547 = "tosa.mul"(%545, %546) {shift = 0 : i8} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    ...
    %558 = "tosa.mul"(%554, %557) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %559 = "tosa.reshape"(%46) {new_shape = array<i64: 1, 1, 1, 576>} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %560 = "tosa.mul"(%558, %559) {shift = 0 : i8} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    ...
    %571 = "tosa.mul"(%567, %570) {shift = 0 : i8} : (tensor<1x7x7x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x7x7x576xf32>
    %572 = "tosa.reshape"(%46) {new_shape = array<i64: 1, 1, 1, 576>} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %573 = "tosa.mul"(%571, %572) {shift = 0 : i8} : (tensor<1x7x7x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x7x7x576xf32>
    ...
    %584 = "tosa.mul"(%580, %583) {shift = 0 : i8} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    %585 = "tosa.reshape"(%49) {new_shape = array<i64: 1, 1, 1, 160>} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    %586 = "tosa.mul"(%584, %585) {shift = 0 : i8} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    ...
    %596 = "tosa.mul"(%592, %595) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %597 = "tosa.reshape"(%52) {new_shape = array<i64: 1, 1, 1, 960>} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %598 = "tosa.mul"(%596, %597) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    ...
    %608 = "tosa.mul"(%604, %607) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %609 = "tosa.reshape"(%52) {new_shape = array<i64: 1, 1, 1, 960>} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %610 = "tosa.mul"(%608, %609) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    ...
    %621 = "tosa.mul"(%617, %620) {shift = 0 : i8} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    %622 = "tosa.reshape"(%49) {new_shape = array<i64: 1, 1, 1, 160>} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    %623 = "tosa.mul"(%621, %622) {shift = 0 : i8} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    ...
    %634 = "tosa.mul"(%630, %633) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %635 = "tosa.reshape"(%52) {new_shape = array<i64: 1, 1, 1, 960>} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %636 = "tosa.mul"(%634, %635) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    ...
    %646 = "tosa.mul"(%642, %645) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %647 = "tosa.reshape"(%52) {new_shape = array<i64: 1, 1, 1, 960>} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %648 = "tosa.mul"(%646, %647) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    ...
    %659 = "tosa.mul"(%655, %658) {shift = 0 : i8} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    %660 = "tosa.reshape"(%49) {new_shape = array<i64: 1, 1, 1, 160>} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    %661 = "tosa.mul"(%659, %660) {shift = 0 : i8} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    ...
    %672 = "tosa.mul"(%668, %671) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %673 = "tosa.reshape"(%52) {new_shape = array<i64: 1, 1, 1, 960>} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %674 = "tosa.mul"(%672, %673) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    ...
    %684 = "tosa.mul"(%680, %683) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %685 = "tosa.reshape"(%52) {new_shape = array<i64: 1, 1, 1, 960>} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %686 = "tosa.mul"(%684, %685) {shift = 0 : i8} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    ...
    %697 = "tosa.mul"(%693, %696) {shift = 0 : i8} : (tensor<1x7x7x320xf32>, tensor<1x1x1x320xf32>) -> tensor<1x7x7x320xf32>
    %698 = "tosa.reshape"(%54) {new_shape = array<i64: 1, 1, 1, 320>} : (tensor<320xf32>) -> tensor<1x1x1x320xf32>
    %699 = "tosa.mul"(%697, %698) {shift = 0 : i8} : (tensor<1x7x7x320xf32>, tensor<1x1x1x320xf32>) -> tensor<1x7x7x320xf32>
    ...
    %709 = "tosa.mul"(%705, %708) {shift = 0 : i8} : (tensor<1x7x7x1280xf32>, tensor<1x1x1x1280xf32>) -> tensor<1x7x7x1280xf32>
    %710 = "tosa.reshape"(%56) {new_shape = array<i64: 1, 1, 1, 1280>} : (tensor<1280xf32>) -> tensor<1x1x1x1280xf32>
    %711 = "tosa.mul"(%709, %710) {shift = 0 : i8} : (tensor<1x7x7x1280xf32>, tensor<1x1x1x1280xf32>) -> tensor<1x7x7x1280xf32>
    ...
    %719 = "tosa.mul"(%717, %718) {shift = 0 : i8} : (tensor<1x1280xf32>, tensor<1x1xf32>) -> tensor<1x1280xf32>
    ...
    %729 = "tosa.mul"(%726, %728) {shift = 0 : i8} : (tensor<1x1000xf32>, tensor<1x1xf32>) -> tensor<1x1000xf32>
