module attributes {tf.versions = {bad_consumers = [], min_consumer = 12 : i32, producer = 812 : i32}, tf_saved_model.semantics}  {
  func @predict(%arg0: tensor<1x224x224x3xf32> {tf._user_specified_name = "args_0", tf_saved_model.index_path = [0]}) -> (tensor<1x1000xf32> {tf_saved_model.index_path = []}) attributes {tf._construction_context = "kEagerRuntime"} {
    ...
    %60 = "tosa.conv2d"(%arg0, %59, %12) {dilation = [1, 1], pad = [0, 1, 0, 1], stride = [2, 2]} : (tensor<1x224x224x3xf32>, tensor<32x3x3x3xf32>, tensor<32xf32>) -> tensor<1x112x112x32xf32>
    %61 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %67 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %68 = "tosa.mul"(%66, %67) {shift = 0 : i32} : (tensor<1x112x112x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x112x112x32xf32>
    %69 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %72 = "tosa.depthwise_conv2d"(%71, %18, %12) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x112x112x32xf32>, tensor<3x3x32x1xf32>, tensor<32xf32>) -> tensor<1x112x112x32xf32>
    %73 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %79 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %80 = "tosa.mul"(%78, %79) {shift = 0 : i32} : (tensor<1x112x112x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x112x112x32xf32>
    %81 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %85 = "tosa.conv2d"(%83, %84, %15) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x112x112x32xf32>, tensor<16x1x1x32xf32>, tensor<16xf32>) -> tensor<1x112x112x16xf32>
    %86 = "tosa.reshape"(%20) {new_shape = [1, 1, 1, 16]} : (tensor<16xf32>) -> tensor<1x1x1x16xf32>
    ...
    %92 = "tosa.reshape"(%20) {new_shape = [1, 1, 1, 16]} : (tensor<16xf32>) -> tensor<1x1x1x16xf32>
    %93 = "tosa.mul"(%91, %92) {shift = 0 : i32} : (tensor<1x112x112x16xf32>, tensor<1x1x1x16xf32>) -> tensor<1x112x112x16xf32>
    %94 = "tosa.reshape"(%20) {new_shape = [1, 1, 1, 16]} : (tensor<16xf32>) -> tensor<1x1x1x16xf32>
    ...
    %97 = "tosa.conv2d"(%95, %96, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x112x112x16xf32>, tensor<96x1x1x16xf32>, tensor<96xf32>) -> tensor<1x112x112x96xf32>
    %98 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %104 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %105 = "tosa.mul"(%103, %104) {shift = 0 : i32} : (tensor<1x112x112x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x112x112x96xf32>
    %106 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %110 = "tosa.depthwise_conv2d"(%109, %22, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [2, 2]} : (tensor<1x113x113x96xf32>, tensor<3x3x96x1xf32>, tensor<96xf32>) -> tensor<1x56x56x96xf32>
    %111 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %117 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %118 = "tosa.mul"(%116, %117) {shift = 0 : i32} : (tensor<1x56x56x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x56x56x96xf32>
    %119 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %123 = "tosa.conv2d"(%121, %122, %14) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x56x56x96xf32>, tensor<24x1x1x96xf32>, tensor<24xf32>) -> tensor<1x56x56x24xf32>
    %124 = "tosa.reshape"(%25) {new_shape = [1, 1, 1, 24]} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    ...
    %130 = "tosa.reshape"(%25) {new_shape = [1, 1, 1, 24]} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    %131 = "tosa.mul"(%129, %130) {shift = 0 : i32} : (tensor<1x56x56x24xf32>, tensor<1x1x1x24xf32>) -> tensor<1x56x56x24xf32>
    %132 = "tosa.reshape"(%25) {new_shape = [1, 1, 1, 24]} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    ...
    %135 = "tosa.conv2d"(%133, %134, %13) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x56x56x24xf32>, tensor<144x1x1x24xf32>, tensor<144xf32>) -> tensor<1x56x56x144xf32>
    %136 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %142 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %143 = "tosa.mul"(%141, %142) {shift = 0 : i32} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    %144 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %147 = "tosa.depthwise_conv2d"(%146, %27, %13) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x56x56x144xf32>, tensor<3x3x144x1xf32>, tensor<144xf32>) -> tensor<1x56x56x144xf32>
    %148 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %154 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %155 = "tosa.mul"(%153, %154) {shift = 0 : i32} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    %156 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %160 = "tosa.conv2d"(%158, %159, %14) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x56x56x144xf32>, tensor<24x1x1x144xf32>, tensor<24xf32>) -> tensor<1x56x56x24xf32>
    %161 = "tosa.reshape"(%25) {new_shape = [1, 1, 1, 24]} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    ...
    %167 = "tosa.reshape"(%25) {new_shape = [1, 1, 1, 24]} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    %168 = "tosa.mul"(%166, %167) {shift = 0 : i32} : (tensor<1x56x56x24xf32>, tensor<1x1x1x24xf32>) -> tensor<1x56x56x24xf32>
    %169 = "tosa.reshape"(%25) {new_shape = [1, 1, 1, 24]} : (tensor<24xf32>) -> tensor<1x1x1x24xf32>
    ...
    %173 = "tosa.conv2d"(%171, %172, %13) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x56x56x24xf32>, tensor<144x1x1x24xf32>, tensor<144xf32>) -> tensor<1x56x56x144xf32>
    %174 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %180 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %181 = "tosa.mul"(%179, %180) {shift = 0 : i32} : (tensor<1x56x56x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x56x56x144xf32>
    %182 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %186 = "tosa.depthwise_conv2d"(%185, %27, %13) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [2, 2]} : (tensor<1x57x57x144xf32>, tensor<3x3x144x1xf32>, tensor<144xf32>) -> tensor<1x28x28x144xf32>
    %187 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %193 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    %194 = "tosa.mul"(%192, %193) {shift = 0 : i32} : (tensor<1x28x28x144xf32>, tensor<1x1x1x144xf32>) -> tensor<1x28x28x144xf32>
    %195 = "tosa.reshape"(%28) {new_shape = [1, 1, 1, 144]} : (tensor<144xf32>) -> tensor<1x1x1x144xf32>
    ...
    %199 = "tosa.conv2d"(%197, %198, %12) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x28x28x144xf32>, tensor<32x1x1x144xf32>, tensor<32xf32>) -> tensor<1x28x28x32xf32>
    %200 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %206 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %207 = "tosa.mul"(%205, %206) {shift = 0 : i32} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    %208 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %211 = "tosa.conv2d"(%209, %210, %11) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x28x28x32xf32>, tensor<192x1x1x32xf32>, tensor<192xf32>) -> tensor<1x28x28x192xf32>
    %212 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %218 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %219 = "tosa.mul"(%217, %218) {shift = 0 : i32} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %220 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %223 = "tosa.depthwise_conv2d"(%222, %33, %11) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x28x28x192xf32>, tensor<3x3x192x1xf32>, tensor<192xf32>) -> tensor<1x28x28x192xf32>
    %224 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %230 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %231 = "tosa.mul"(%229, %230) {shift = 0 : i32} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %232 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %236 = "tosa.conv2d"(%234, %235, %12) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x28x28x192xf32>, tensor<32x1x1x192xf32>, tensor<32xf32>) -> tensor<1x28x28x32xf32>
    %237 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %243 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %244 = "tosa.mul"(%242, %243) {shift = 0 : i32} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    %245 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %249 = "tosa.conv2d"(%247, %248, %11) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x28x28x32xf32>, tensor<192x1x1x32xf32>, tensor<192xf32>) -> tensor<1x28x28x192xf32>
    %250 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %256 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %257 = "tosa.mul"(%255, %256) {shift = 0 : i32} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %258 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %261 = "tosa.depthwise_conv2d"(%260, %33, %11) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x28x28x192xf32>, tensor<3x3x192x1xf32>, tensor<192xf32>) -> tensor<1x28x28x192xf32>
    %262 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %268 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %269 = "tosa.mul"(%267, %268) {shift = 0 : i32} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %270 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %274 = "tosa.conv2d"(%272, %273, %12) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x28x28x192xf32>, tensor<32x1x1x192xf32>, tensor<32xf32>) -> tensor<1x28x28x32xf32>
    %275 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %281 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    %282 = "tosa.mul"(%280, %281) {shift = 0 : i32} : (tensor<1x28x28x32xf32>, tensor<1x1x1x32xf32>) -> tensor<1x28x28x32xf32>
    %283 = "tosa.reshape"(%31) {new_shape = [1, 1, 1, 32]} : (tensor<32xf32>) -> tensor<1x1x1x32xf32>
    ...
    %287 = "tosa.conv2d"(%285, %286, %11) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x28x28x32xf32>, tensor<192x1x1x32xf32>, tensor<192xf32>) -> tensor<1x28x28x192xf32>
    %288 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %294 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %295 = "tosa.mul"(%293, %294) {shift = 0 : i32} : (tensor<1x28x28x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x28x28x192xf32>
    %296 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %300 = "tosa.depthwise_conv2d"(%299, %33, %11) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [2, 2]} : (tensor<1x29x29x192xf32>, tensor<3x3x192x1xf32>, tensor<192xf32>) -> tensor<1x14x14x192xf32>
    %301 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %307 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    %308 = "tosa.mul"(%306, %307) {shift = 0 : i32} : (tensor<1x14x14x192xf32>, tensor<1x1x1x192xf32>) -> tensor<1x14x14x192xf32>
    %309 = "tosa.reshape"(%34) {new_shape = [1, 1, 1, 192]} : (tensor<192xf32>) -> tensor<1x1x1x192xf32>
    ...
    %313 = "tosa.conv2d"(%311, %312, %10) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x192xf32>, tensor<64x1x1x192xf32>, tensor<64xf32>) -> tensor<1x14x14x64xf32>
    %314 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %320 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %321 = "tosa.mul"(%319, %320) {shift = 0 : i32} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %322 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %325 = "tosa.conv2d"(%323, %324, %9) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x64xf32>, tensor<384x1x1x64xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %326 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %332 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %333 = "tosa.mul"(%331, %332) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %334 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %337 = "tosa.depthwise_conv2d"(%336, %39, %9) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<3x3x384x1xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %338 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %344 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %345 = "tosa.mul"(%343, %344) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %346 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %350 = "tosa.conv2d"(%348, %349, %10) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<64x1x1x384xf32>, tensor<64xf32>) -> tensor<1x14x14x64xf32>
    %351 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %357 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %358 = "tosa.mul"(%356, %357) {shift = 0 : i32} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %359 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %363 = "tosa.conv2d"(%361, %362, %9) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x64xf32>, tensor<384x1x1x64xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %364 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %370 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %371 = "tosa.mul"(%369, %370) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %372 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %375 = "tosa.depthwise_conv2d"(%374, %39, %9) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<3x3x384x1xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %376 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %382 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %383 = "tosa.mul"(%381, %382) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %384 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %388 = "tosa.conv2d"(%386, %387, %10) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<64x1x1x384xf32>, tensor<64xf32>) -> tensor<1x14x14x64xf32>
    %389 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %395 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %396 = "tosa.mul"(%394, %395) {shift = 0 : i32} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %397 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %401 = "tosa.conv2d"(%399, %400, %9) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x64xf32>, tensor<384x1x1x64xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %402 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %408 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %409 = "tosa.mul"(%407, %408) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %410 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %413 = "tosa.depthwise_conv2d"(%412, %39, %9) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<3x3x384x1xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %414 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %420 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %421 = "tosa.mul"(%419, %420) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %422 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %426 = "tosa.conv2d"(%424, %425, %10) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<64x1x1x384xf32>, tensor<64xf32>) -> tensor<1x14x14x64xf32>
    %427 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %433 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    %434 = "tosa.mul"(%432, %433) {shift = 0 : i32} : (tensor<1x14x14x64xf32>, tensor<1x1x1x64xf32>) -> tensor<1x14x14x64xf32>
    %435 = "tosa.reshape"(%37) {new_shape = [1, 1, 1, 64]} : (tensor<64xf32>) -> tensor<1x1x1x64xf32>
    ...
    %439 = "tosa.conv2d"(%437, %438, %9) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x64xf32>, tensor<384x1x1x64xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %440 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %446 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %447 = "tosa.mul"(%445, %446) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %448 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %451 = "tosa.depthwise_conv2d"(%450, %39, %9) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<3x3x384x1xf32>, tensor<384xf32>) -> tensor<1x14x14x384xf32>
    %452 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %458 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    %459 = "tosa.mul"(%457, %458) {shift = 0 : i32} : (tensor<1x14x14x384xf32>, tensor<1x1x1x384xf32>) -> tensor<1x14x14x384xf32>
    %460 = "tosa.reshape"(%40) {new_shape = [1, 1, 1, 384]} : (tensor<384xf32>) -> tensor<1x1x1x384xf32>
    ...
    %464 = "tosa.conv2d"(%462, %463, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x384xf32>, tensor<96x1x1x384xf32>, tensor<96xf32>) -> tensor<1x14x14x96xf32>
    %465 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %471 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %472 = "tosa.mul"(%470, %471) {shift = 0 : i32} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    %473 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %476 = "tosa.conv2d"(%474, %475, %7) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x96xf32>, tensor<576x1x1x96xf32>, tensor<576xf32>) -> tensor<1x14x14x576xf32>
    %477 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %483 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %484 = "tosa.mul"(%482, %483) {shift = 0 : i32} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %485 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %488 = "tosa.depthwise_conv2d"(%487, %45, %7) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x14x14x576xf32>, tensor<3x3x576x1xf32>, tensor<576xf32>) -> tensor<1x14x14x576xf32>
    %489 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %495 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %496 = "tosa.mul"(%494, %495) {shift = 0 : i32} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %497 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %501 = "tosa.conv2d"(%499, %500, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x576xf32>, tensor<96x1x1x576xf32>, tensor<96xf32>) -> tensor<1x14x14x96xf32>
    %502 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %508 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %509 = "tosa.mul"(%507, %508) {shift = 0 : i32} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    %510 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %514 = "tosa.conv2d"(%512, %513, %7) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x96xf32>, tensor<576x1x1x96xf32>, tensor<576xf32>) -> tensor<1x14x14x576xf32>
    %515 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %521 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %522 = "tosa.mul"(%520, %521) {shift = 0 : i32} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %523 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %526 = "tosa.depthwise_conv2d"(%525, %45, %7) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x14x14x576xf32>, tensor<3x3x576x1xf32>, tensor<576xf32>) -> tensor<1x14x14x576xf32>
    %527 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %533 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %534 = "tosa.mul"(%532, %533) {shift = 0 : i32} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %535 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %539 = "tosa.conv2d"(%537, %538, %8) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x576xf32>, tensor<96x1x1x576xf32>, tensor<96xf32>) -> tensor<1x14x14x96xf32>
    %540 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %546 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    %547 = "tosa.mul"(%545, %546) {shift = 0 : i32} : (tensor<1x14x14x96xf32>, tensor<1x1x1x96xf32>) -> tensor<1x14x14x96xf32>
    %548 = "tosa.reshape"(%43) {new_shape = [1, 1, 1, 96]} : (tensor<96xf32>) -> tensor<1x1x1x96xf32>
    ...
    %552 = "tosa.conv2d"(%550, %551, %7) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x14x14x96xf32>, tensor<576x1x1x96xf32>, tensor<576xf32>) -> tensor<1x14x14x576xf32>
    %553 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %559 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %560 = "tosa.mul"(%558, %559) {shift = 0 : i32} : (tensor<1x14x14x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x14x14x576xf32>
    %561 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %565 = "tosa.depthwise_conv2d"(%564, %45, %7) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [2, 2]} : (tensor<1x15x15x576xf32>, tensor<3x3x576x1xf32>, tensor<576xf32>) -> tensor<1x7x7x576xf32>
    %566 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %572 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    %573 = "tosa.mul"(%571, %572) {shift = 0 : i32} : (tensor<1x7x7x576xf32>, tensor<1x1x1x576xf32>) -> tensor<1x7x7x576xf32>
    %574 = "tosa.reshape"(%46) {new_shape = [1, 1, 1, 576]} : (tensor<576xf32>) -> tensor<1x1x1x576xf32>
    ...
    %578 = "tosa.conv2d"(%576, %577, %6) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x576xf32>, tensor<160x1x1x576xf32>, tensor<160xf32>) -> tensor<1x7x7x160xf32>
    %579 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    ...
    %585 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    %586 = "tosa.mul"(%584, %585) {shift = 0 : i32} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    %587 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    ...
    %590 = "tosa.conv2d"(%588, %589, %5) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x160xf32>, tensor<960x1x1x160xf32>, tensor<960xf32>) -> tensor<1x7x7x960xf32>
    %591 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %597 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %598 = "tosa.mul"(%596, %597) {shift = 0 : i32} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %599 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %602 = "tosa.depthwise_conv2d"(%601, %51, %5) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x7x7x960xf32>, tensor<3x3x960x1xf32>, tensor<960xf32>) -> tensor<1x7x7x960xf32>
    %603 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %609 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %610 = "tosa.mul"(%608, %609) {shift = 0 : i32} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %611 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %615 = "tosa.conv2d"(%613, %614, %6) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x960xf32>, tensor<160x1x1x960xf32>, tensor<160xf32>) -> tensor<1x7x7x160xf32>
    %616 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    ...
    %622 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    %623 = "tosa.mul"(%621, %622) {shift = 0 : i32} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    %624 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    ...
    %628 = "tosa.conv2d"(%626, %627, %5) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x160xf32>, tensor<960x1x1x160xf32>, tensor<960xf32>) -> tensor<1x7x7x960xf32>
    %629 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %635 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %636 = "tosa.mul"(%634, %635) {shift = 0 : i32} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %637 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %640 = "tosa.depthwise_conv2d"(%639, %51, %5) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x7x7x960xf32>, tensor<3x3x960x1xf32>, tensor<960xf32>) -> tensor<1x7x7x960xf32>
    %641 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %647 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %648 = "tosa.mul"(%646, %647) {shift = 0 : i32} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %649 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %653 = "tosa.conv2d"(%651, %652, %6) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x960xf32>, tensor<160x1x1x960xf32>, tensor<160xf32>) -> tensor<1x7x7x160xf32>
    %654 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    ...
    %660 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    %661 = "tosa.mul"(%659, %660) {shift = 0 : i32} : (tensor<1x7x7x160xf32>, tensor<1x1x1x160xf32>) -> tensor<1x7x7x160xf32>
    %662 = "tosa.reshape"(%49) {new_shape = [1, 1, 1, 160]} : (tensor<160xf32>) -> tensor<1x1x1x160xf32>
    ...
    %666 = "tosa.conv2d"(%664, %665, %5) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x160xf32>, tensor<960x1x1x160xf32>, tensor<960xf32>) -> tensor<1x7x7x960xf32>
    %667 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %673 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %674 = "tosa.mul"(%672, %673) {shift = 0 : i32} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %675 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %678 = "tosa.depthwise_conv2d"(%677, %51, %5) {dilation = [1, 1], pad = [1, 1, 1, 1], stride = [1, 1]} : (tensor<1x7x7x960xf32>, tensor<3x3x960x1xf32>, tensor<960xf32>) -> tensor<1x7x7x960xf32>
    %679 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %685 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    %686 = "tosa.mul"(%684, %685) {shift = 0 : i32} : (tensor<1x7x7x960xf32>, tensor<1x1x1x960xf32>) -> tensor<1x7x7x960xf32>
    %687 = "tosa.reshape"(%52) {new_shape = [1, 1, 1, 960]} : (tensor<960xf32>) -> tensor<1x1x1x960xf32>
    ...
    %691 = "tosa.conv2d"(%689, %690, %4) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x960xf32>, tensor<320x1x1x960xf32>, tensor<320xf32>) -> tensor<1x7x7x320xf32>
    %692 = "tosa.reshape"(%54) {new_shape = [1, 1, 1, 320]} : (tensor<320xf32>) -> tensor<1x1x1x320xf32>
    ...
    %698 = "tosa.reshape"(%54) {new_shape = [1, 1, 1, 320]} : (tensor<320xf32>) -> tensor<1x1x1x320xf32>
    %699 = "tosa.mul"(%697, %698) {shift = 0 : i32} : (tensor<1x7x7x320xf32>, tensor<1x1x1x320xf32>) -> tensor<1x7x7x320xf32>
    %700 = "tosa.reshape"(%54) {new_shape = [1, 1, 1, 320]} : (tensor<320xf32>) -> tensor<1x1x1x320xf32>
    ...
    %703 = "tosa.conv2d"(%701, %702, %3) {dilation = [1, 1], pad = [0, 0, 0, 0], stride = [1, 1]} : (tensor<1x7x7x320xf32>, tensor<1280x1x1x320xf32>, tensor<1280xf32>) -> tensor<1x7x7x1280xf32>
    %704 = "tosa.reshape"(%56) {new_shape = [1, 1, 1, 1280]} : (tensor<1280xf32>) -> tensor<1x1x1x1280xf32>
    ...
    %710 = "tosa.reshape"(%56) {new_shape = [1, 1, 1, 1280]} : (tensor<1280xf32>) -> tensor<1x1x1x1280xf32>
    %711 = "tosa.mul"(%709, %710) {shift = 0 : i32} : (tensor<1x7x7x1280xf32>, tensor<1x1x1x1280xf32>) -> tensor<1x7x7x1280xf32>
    %712 = "tosa.reshape"(%56) {new_shape = [1, 1, 1, 1280]} : (tensor<1280xf32>) -> tensor<1x1x1x1280xf32>
    ...
    %718 = "tosa.reshape"(%0) {new_shape = [1, 1]} : (tensor<f32>) -> tensor<1x1xf32>
    %719 = "tosa.mul"(%717, %718) {shift = 0 : i32} : (tensor<1x1280xf32>, tensor<1x1xf32>) -> tensor<1x1280xf32>
    %720 = "tosa.reshape"(%719) {new_shape = [1, 1, 1280]} : (tensor<1x1280xf32>) -> tensor<1x1x1280xf32>
    %721 = "tosa.reshape"(%57) {new_shape = [1, 1280, 1000]} : (tensor<1280x1000xf32>) -> tensor<1x1280x1000xf32>
    %722 = "tosa.matmul"(%720, %721) : (tensor<1x1x1280xf32>, tensor<1x1280x1000xf32>) -> tensor<1x1x1000xf32>
    %723 = "tosa.reshape"(%722) {new_shape = [1, 1000]} : (tensor<1x1x1000xf32>) -> tensor<1x1000xf32>
    %724 = "tosa.reshape"(%58) {new_shape = [1, 1000]} : (tensor<1000xf32>) -> tensor<1x1000xf32>
